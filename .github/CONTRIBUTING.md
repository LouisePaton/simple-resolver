...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`LouisePaton/simple-resolver`](https://github.com/LouisePaton/simple-resolver)
...
```shell
$ git remote add LouisePaton https://github.com/LouisePaton/simple-resolver.git
```
